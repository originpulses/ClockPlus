...
- Heroku URL: https://rad-clockplus.herokuapp.com/
...
-----> Installing dependencies using bundler 2.0.2
       ...
       Using activerecord-import 1.0.5
...
-----> Preparing app for Rails asset pipeline
       ...
       Asset precompilation completed (1.86s)
...
-----> Launching...
       ...
       https://rad-clockplus.herokuapp.com/ deployed to Heroku
```
